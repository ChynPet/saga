defmodule Sagas.Instagram.SignIn do
  ...
  @spec login(pid, Saga.Api.UserInstagram.t()) :: :ok
  def login(pid, user) do
    GenStateMachine.cast(pid, {:login, user})
  end

  @spec create_token(pid, Saga.Api.UserInstagram.t()) :: :ok
  def create_token(pid, data) do
    GenStateMachine.cast(pid, {:create_token, data})
  end

  @spec save_token_notification(pid, Saga.Api.UserInstagram.t()) :: :ok
  ...
  #Send on instagram
  @spec sign_in(:cast, {:login, Saga.Api.UserInstagram.t()}, any) ::
           {:next_state, :authentication | :error,
             {:authentication, Saga.Api.UserInstagram.t()}
             | {:error, String.t()}}
  ...
  @spec authentication(:cast, {:create_token, Saga.Api.UserInstagram.t()}, {:authentication, Saga.Api.UserInstagram.t()}) ::
          {:next_state, :error | :save_token,
             {:error, String.t()} | {:save_token, Saga.Api.UserInstagram.t()}}
  ...
  @spec authentication({:call, any}, {:get_data}, any) ::
    {:keep_state_and_data, [{:reply, any, any}, ...]}
    | {:next_state, :error | :save_token,
       {:error, String.t()} | {:save_token, Saga.Api.UserInstagram.t()}}
  ...
  @spec save_token(:cast,{:save_token_notification, Saga.Api.UserInstagram.t()},{:save_token, Saga.Api.UserInstagram.t()}) ::
