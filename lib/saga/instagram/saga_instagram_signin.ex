defmodule Sagas.Instagram.SignIn do
  ...
  def sign_in(:cast, {:mouth, user}, _loop_data) do
    struct_message = %{token: user.token_instagram, userid: user.user_idinstagram}
  ...
  @spec answer_authentication :: false | nil | true | binary | [any] | number | map
  def answer_authentication do
    KafkaEx.produce(Kafka.Topics.sign_in_instagram, 0 , "{\"user_id\": \"1\", \"token\": \"5\", \"answer\": \"ok\"}")
    res = KafkaEx.fetch(Kafka.Topics.sign_in_instagram, 0)
  ...
  @spec answer_authentication(tuple) :: false | nil | true | binary | [any] | number | map
